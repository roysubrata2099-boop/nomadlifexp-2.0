                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {[
                            ...
                            },
                            {
                                ...
                                desc: "Self discipline is the ability to control your actions based on long-term goals instead of short-term feelings. Discover why most people do not lack motivationùthey lack systems that protect their attention from constant distraction.",
                ...
                <section className="mb-24">
                    <div className="flex justify-between items-end mb-8 border-b border-neutral-900 pb-4">
                        ...
                        <span className="font-mono text-xs text-neutral-400">
                            {disciplineArticles.length > 0 ? `${disciplineArticles.length} ARTICLES` : "DYNAMIC DATABASE"}
                        </span>
                    </div>
                    ...
                    {disciplineArticles.length === 0 ? (
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                ...
                                {
                                    title: "Self-Discipline Guide: Reclaim Your Attention, Rebuild Your Life",
                                    description: "Most people believe they lack discipline. They call themselves lazy, inconsistent, or unmotivated. But the truth is deeper. The real challenge is learning how to control your attention and rebuild your systems.",
                                    slug: "self-discipline-guide-reclaim-your-attention-rebuild-your-life"
                                },
                                {
                                    title: "Why You Procrastinate and How to Stop It Permanently",
                                    description: "Procrastination is not a sign of laziness. It is often an emotional regulation challenge. Learn why procrastination happens and how to create lasting change.",
                                    slug: "why-you-procrastinate-and-how-to-stop-it-permanently"
                                }
                            ].map((post) => (
                                <article
