                ...
                <div className="max-w-[1200px] w-[92%] mx-auto relative z-10">
                    ...
                    <header className="py-16 md:py-20 max-w-5xl">
                        ...
                        <h1 className="text-4xl md:text-[56px] lg:text-[60px] font-black leading-tight mb-7 tracking-tight uppercase">
                            ...
                            <span className="text-[#D6A500]">The Foundation System of Human Optimization</span>
                        </h1>
                        ...
                        <div className="bg-[#101010] border-l-2 border-[#D6A500] p-6 md:p-8 max-w-[850px] my-8 space-y-4">
                            ...
                            <p className="text-white font-semibold italic text-sm md:text-base border-l border-[#D6A500] pl-4 py-1">
                                Stop relying on motivation. Motivation fades. Systems endure.
                            </p>
                            <p className="text-[#D6A500] font-mono uppercase text-sm tracking-widest font-bold pt-2">
                    ...
                    <section className="mb-20 space-y-6 border border-[#222] bg-[#101010] p-8 md:p-12" aria-label="What Is The Discipline System">
                        ...
                        <p className="text-sm font-mono text-[#777] uppercase tracking-wider">The framework combines:</p>
                        <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-[#ccc] font-light">
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Identity-based habits</li>
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Habit building systems</li>
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Daily discipline routines</li>
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Environmental design</li>
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Somatic anchors</li>
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Attention protection</li>
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Behaviour change principles</li>
                        </ul>
                        <div className="pt-4 border-t border-[#222] space-y-2">
                            ...
                            <p className="text-[#D6A500] text-sm md:text-base font-light">Transformation is created through systems that reshape your actions, reinforce your identity, and improve your ability to execute.</p>
                        </div>
                    </section>
                    ...
                    <section className="mb-20 space-y-8" aria-label="Evolution Framework">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                            <div className="space-y-6 border border-[#222] bg-[#101010] p-8">
                                ...
                                <p className="text-xs font-mono text-[#777] uppercase">Before developing:</p>
                                <ul className="space-y-2 text-xs md:text-sm text-[#ccc] font-light">
                                    <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Physical performance</li>
                                    <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Strength and fitness</li>
                                    <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Mobility and recovery</li>
                                    <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Mental performance</li>
                                    <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Personal growth</li>
                                </ul>
                                <p className="text-[#aaa] text-sm md:text-base leading-relaxed font-light">
                            ...
                            <div className="border border-[#222] bg-[#101010] p-8 text-center font-mono space-y-3">
                                ...
                                <div className="p-3 bg-[#0d0d0d] border border-[#222] text-white text-sm uppercase">HUMAN EVOLUTION</div>
                                ...
                                <div className="text-[#777]">↑</div>
                                <div className="p-3 bg-[#0d0d0d] border border-[#D6A500] text-black font-bold text-sm uppercase bg-[#D6A500]">DISCIPLINE SYSTEM</div>
                                <div className="text-[#777]">↑</div>
                                <div className="p-3 bg-[#0d0d0d] border border-[#222] text-[#D6A500] text-xs uppercase font-bold">Identity → Habits → Actions → Results</div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-20 space-y-8" aria-label="Discipline Architecture">
                        <div className="border-b border-[#222] pb-4">
                            ...
                            <p className="text-sm font-mono text-[#D6A500] uppercase tracking-widest mt-1">A Complete Self-Discipline Framework</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="border border-[#222] bg-[#101010] p-6">
                                <div className="text-[#D6A500] font-mono text-xs mb-2 font-bold tracking-widest">D — DAILY STRUCTURE</div>
                                <h3 className="text-lg font-bold uppercase text-white mb-2">Remove Decision Fatigue</h3>
                                <p className="text-xs md:text-sm text-[#aaa] font-light mb-3">Create routines that remove decision fatigue.</p>
                                <p className="text-[11px] font-mono text-[#777] uppercase mb-1">Build:</p>
                                <ul className="space-y-1 text-xs text-[#ccc] font-light">
                            ...
                            <div className="border border-[#222] bg-[#101010] p-6">
                                <div className="text-[#D6A500] font-mono text-xs mb-2 font-bold tracking-widest">I — IDENTITY ALIGNMENT</div>
                                <h3 className="text-lg font-bold uppercase text-white mb-2">Shape Your Core Identity</h3>
                                <p className="text-xs md:text-sm text-[#aaa] font-light">Your repeated actions become evidence of who you are becoming. Build the identity of a disciplined person through consistent behaviour.</p>
                            </div>

                            <div className="border border-[#222] bg-[#101010] p-6">
                                <div className="text-[#D6A500] font-mono text-xs mb-2 font-bold tracking-widest">S — SOMATIC ANCHORS</div>
                                <h3 className="text-lg font-bold uppercase text-white mb-2">Use Physical Triggers</h3>
                                <p className="text-xs md:text-sm text-[#aaa] font-light mb-3">Use physical triggers to reinforce habits. Your body becomes an anchor for disciplined action.</p>
                                <p className="text-[11px] font-mono text-[#777] uppercase mb-1">Examples:</p>
                                <ul className="space-y-1 text-xs text-[#ccc] font-light">
                                    <li>✓ Movement</li>
                                    <li>✓ Hydration</li>
                            ...
                            <div className="border border-[#222] bg-[#101010] p-6">
                                <div className="text-[#D6A500] font-mono text-xs mb-2 font-bold tracking-widest">C — COGNITIVE CONTROL</div>
                                <h3 className="text-lg font-bold uppercase text-white mb-2">Protect Attention</h3>
                                <p className="text-xs md:text-sm text-[#aaa] font-light mb-3">Protect attention and mental energy.</p>
                                <p className="text-[11px] font-mono text-[#777] uppercase mb-1">Reduce:</p>
                                <ul className="space-y-1 text-xs text-[#ccc] font-light">
                            ...
                            <div className="border border-[#222] bg-[#101010] p-6">
                                <div className="text-[#D6A500] font-mono text-xs mb-2 font-bold tracking-widest">I — INTENTIONAL EXECUTION</div>
                                <h3 className="text-lg font-bold uppercase text-white mb-2">Turn Goals Into Action</h3>
                                <p className="text-xs md:text-sm text-[#aaa] font-light mb-3">Turn goals into consistent action.</p>
                                <p className="text-[11px] font-mono text-[#777] uppercase mb-1">Develop:</p>
                                <ul className="space-y-1 text-xs text-[#ccc] font-light">
                            ...
                            <div className="border border-[#222] bg-[#101010] p-6">
                                <div className="text-[#D6A500] font-mono text-xs mb-2 font-bold tracking-widest">P — PHYSICAL FOUNDATIONS</div>
                                <h3 className="text-lg font-bold uppercase text-white mb-2">Support Biology</h3>
                                <p className="text-xs md:text-sm text-[#aaa] font-light mb-3">Support discipline through:</p>
                                <ul className="space-y-1 text-xs text-[#ccc] font-light">
                                    <li>✓ Exercise</li>
                                    <li>✓ Nutrition</li>
                                    <li>✓ Recovery</li>
                            ...
                            <div className="border border-[#222] bg-[#101010] p-6">
                                <div className="text-[#D6A500] font-mono text-xs mb-2 font-bold tracking-widest">L — LIFESTYLE DESIGN</div>
                                <h3 className="text-lg font-bold uppercase text-white mb-2">Optimize Environment</h3>
                                <p className="text-xs md:text-sm text-[#aaa] font-light">Create an environment that supports your desired identity.</p>
                            </div>

                            <div className="border border-[#222] bg-[#101010] p-6">
                                <div className="text-[#D6A500] font-mono text-xs mb-2 font-bold tracking-widest">I — INTERNAL INTEGRITY</div>
                                <h3 className="text-lg font-bold uppercase text-white mb-2">Build Self-Trust</h3>
                                <p className="text-xs md:text-sm text-[#aaa] font-light">Develop self-trust through keeping commitments to yourself.</p>
                            </div>

                            <div className="border border-[#222] bg-[#101010] p-6">
                                <div className="text-[#D6A500] font-mono text-xs mb-2 font-bold tracking-widest">N — NEURAL REINFORCEMENT</div>
                                <h3 className="text-lg font-bold uppercase text-white mb-2">Strengthen Pathways</h3>
                                <p className="text-xs md:text-sm text-[#aaa] font-light">Repeated behaviours become stronger through consistent repetition.</p>
                            </div>

                            <div className="border border-[#222] bg-[#101010] p-6 md:col-span-3">
                                <div className="text-[#D6A500] font-mono text-xs mb-2 font-bold tracking-widest">E — EVOLUTION PROTOCOL</div>
                                <h3 className="text-lg font-bold uppercase text-white mb-2">Lifelong Development</h3>
                                <p className="text-xs md:text-sm text-[#aaa] font-light">Continue improving through lifelong development.</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="thirty-day-system" className="mb-20 space-y-8" aria-label="30-Day Discipline System">
                        <div className="border-b border-[#222] pb-4">
                            ...
                            <p className="text-sm font-mono text-[#D6A500] uppercase tracking-widest mt-1">Build Your New Operating System</p>
                        </div>
                        <p className="text-[#aaa] text-base font-light">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {/* Phase I */}
                            <div className="border border-[#222] bg-[#101010] p-8 flex flex-col justify-between space-y-4">
                                <div>
                                    <div className="text-[#D6A500] text-[12px] font-mono mb-1 tracking-wider">Phase I // Internal Integrity</div>
                                    <h3 className="text-xl font-bold mb-2 uppercase tracking-tight text-white">Build Control</h3>
                                    <p className="text-xs font-mono text-[#777] uppercase mb-4">Days 1–10</p>
                                    <p className="text-xs font-mono text-[#aaa] uppercase mb-2">Focus:</p>
                                    <ul className="space-y-2 text-xs text-[#ccc] font-light mb-6">
                                ...
                                <div className="border-t border-[#222] pt-4">
                                    <p className="text-[11px] font-mono text-[#D6A500] uppercase mb-1">Outcome:</p>
                                    <p className="text-xs text-[#aaa] font-light">Develop control over your environment, focus, and daily actions.</p>
                                </div>
                            </div>
                            ...
                            <div className="border border-[#222] bg-[#101010] p-8 flex flex-col justify-between space-y-4">
                                <div>
                                    <div className="text-[#D6A500] text-[12px] font-mono mb-1 tracking-wider">Phase II // Physical Baselines</div>
                                    <h3 className="text-xl font-bold mb-2 uppercase tracking-tight text-white">Build Energy</h3>
                                    <p className="text-xs font-mono text-[#777] uppercase mb-4">Days 11–20</p>
                                    <p className="text-xs font-mono text-[#aaa] uppercase mb-2">Focus:</p>
                                    <ul className="space-y-2 text-xs text-[#ccc] font-light mb-6">
                                ...
                                <div className="border-t border-[#222] pt-4">
                                    <p className="text-[11px] font-mono text-[#D6A500] uppercase mb-1">Outcome:</p>
                                    <p className="text-xs text-[#aaa] font-light">Create the physical foundation required for performance.</p>
                                </div>
                            </div>
                            ...
                            <div className="border border-[#222] bg-[#101010] p-8 flex flex-col justify-between space-y-4">
                                <div>
                                    <div className="text-[#D6A500] text-[12px] font-mono mb-1 tracking-wider">Phase III // Velocity Output</div>
                                    <h3 className="text-xl font-bold mb-2 uppercase tracking-tight text-white">Build Performance</h3>
                                    <p className="text-xs font-mono text-[#777] uppercase mb-4">Days 21–30</p>
                                    <p className="text-xs font-mono text-[#aaa] uppercase mb-2">Focus:</p>
                                    <ul className="space-y-2 text-xs text-[#ccc] font-light mb-6">
                                        <li>✓ Deep work</li>
                                ...
                                <div className="border-t border-[#222] pt-4">
                                    <p className="text-[11px] font-mono text-[#D6A500] uppercase mb-1">Outcome:</p>
                                    <p className="text-xs text-[#aaa] font-light">Transform discipline into measurable performance.</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-20 space-y-8" aria-label="Daily Discipline Routine">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="border border-[#222] bg-[#101010] p-6 space-y-3">
                                <h3 className="text-lg font-bold uppercase text-[#D6A500]">Morning Activation</h3>
                                <p className="text-xs text-[#aaa] font-light">Create a strong start.</p>
                            ...
                            <div className="border border-[#222] bg-[#101010] p-6 space-y-3">
                                <h3 className="text-lg font-bold uppercase text-[#D6A500]">Daily Execution</h3>
                                <p className="text-xs text-[#aaa] font-light">Protect your progress.</p>
                                <ul className="space-y-1.5 text-xs text-[#ccc] font-light">
                                    <li>✓ Deep work</li>
                                    <li>✓ Exercise</li>
                                    <li>✓ Nutrition</li>
                            ...
                            <div className="border border-[#222] bg-[#101010] p-6 space-y-3">
                                <h3 className="text-lg font-bold uppercase text-[#D6A500]">Evening Reset</h3>
                                <p className="text-xs text-[#aaa] font-light">Prepare for recovery.</p>
                                <ul className="space-y-1.5 text-xs text-[#ccc] font-light">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
                        <section className="border border-[#222] bg-[#101010] p-8 space-y-4" aria-label="Attention Protection System">
                            <h2 className="text-xl font-bold uppercase text-white">
                                Attention Protection System™
                            </h2>
                            <p className="text-xs font-mono text-[#D6A500] uppercase tracking-wider">Control Your Inputs</p>
                            ...
                            <p className="text-xs font-mono text-[#777] uppercase">Protect:</p>
                            <ul className="space-y-1 text-xs text-[#ccc] font-light">
                                <li>✓ Focus</li>
                                <li>✓ Energy</li>
                        ...
                        <section className="border border-[#222] bg-[#101010] p-8 space-y-4" aria-label="Somatic Habit Engineering">
                            <h2 className="text-xl font-bold uppercase text-white">
                                Somatic Habit Engineering™
                            </h2>
                            <p className="text-xs font-mono text-[#D6A500] uppercase tracking-wider">Discipline Through The Body</p>
                            <p className="text-sm text-[#aaa] font-light leading-relaxed">
                                Discipline is not built through willpower alone. Physical anchors create reliable behaviour triggers.
                            </p>
                            <ul className="space-y-2 text-xs text-[#ccc] font-light pt-2">
                            ...
                            <p className="text-xs text-[#D6A500] font-mono pt-2">Your body becomes part of your discipline system.</p>
                        </section>
                    </div>
                    ...
                    <section className="mb-20 space-y-6" aria-label="Comparison Table">
                        ...
                        <div className="overflow-x-auto border border-[#222]">
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="border-b border-[#222] bg-[#101010] text-xs font-mono uppercase text-[#D6A500]">
                                        <th className="p-4 border-r border-[#222]">Metric</th>
                                        <th className="p-4 border-r border-[#222]">Motivation-Based Effort</th>
                                        <th className="p-4">Identity-Based System</th>
                                    </tr>
                                </thead>
                                <tbody className="text-xs md:text-sm text-[#ccc] font-light divide-y divide-[#222]">
                                    <tr className="bg-[#0b0b0b]">
                                        <td className="p-4 font-mono text-[#aaa] border-r border-[#222]">Driver</td>
                                        <td className="p-4 border-r border-[#222]">Temporary feelings</td>
                                        <td className="p-4 text-white font-medium">Structured behaviours</td>
                                    </tr>
                                    <tr className="bg-[#101010]">
                                        <td className="p-4 font-mono text-[#aaa] border-r border-[#222]">Consistency</td>
                                        <td className="p-4 border-r border-[#222]">Unpredictable</td>
                                        <td className="p-4 text-white font-medium">Repeatable</td>
                                    </tr>
                                    <tr className="bg-[#0b0b0b]">
                                        <td className="p-4 font-mono text-[#aaa] border-r border-[#222]">Decision Energy</td>
                                        <td className="p-4 border-r border-[#222]">High</td>
                                        <td className="p-4 text-white font-medium">Reduced</td>
                                    </tr>
                                    <tr className="bg-[#101010]">
                                        <td className="p-4 font-mono text-[#aaa] border-r border-[#222]">Outcome</td>
                                        <td className="p-4 border-r border-[#222]">Short-term bursts</td>
                    ...
                    <section className="mb-20 space-y-6 border border-[#222] bg-[#101010] p-8 md:p-12" aria-label="Benefits">
                        <h2 className="text-2xl md:text-3xl font-bold uppercase tracking-tight text-white">
                            Benefits Of The Discipline System™
                        </h2>
                        <ul className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-[#ccc] font-light pt-2">
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Build self-discipline</li>
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Build lasting habits</li>
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Improve focus</li>
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Reduce procrastination</li>
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Increase productivity</li>
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Develop accountability</li>
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Strengthen confidence</li>
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Create sustainable routines</li>
                            <li className="flex items-center gap-2"><span className="text-[#D6A500]">✓</span> Support human optimization</li>
                        </ul>
                    </section>
                    ...
                    <section className="border border-[#222] bg-[#101010] p-8 md:p-12 mb-20 space-y-6 text-center" aria-label="System Integration">
                        ...
                        <div className="max-w-md mx-auto space-y-3 font-mono text-sm">
                            <div className="p-3 bg-[#0d0d0d] border border-[#D6A500] text-[#D6A500] font-bold uppercase">The Discipline System creates the foundation.</div>
                            <div className="text-[#555]">↓</div>
                            <div className="p-3 bg-[#0d0d0d] border border-[#222] text-white uppercase">The Fitness System develops physical capability.</div>
                            <div className="text-[#555]">↓</div>
                            <div className="p-3 bg-[#0d0d0d] border border-[#222] text-white uppercase">The Yoga System improves mobility, awareness, and recovery.</div>
                            <div className="text-[#555]">↓</div>
                            <div className="p-3 bg-[#0d0d0d] border border-[#222] text-white uppercase">The Mindset System develops resilience and mental performance.</div>
                        </div>
                        <p className="text-sm text-[#aaa] font-light pt-2">
                    ...
                    <section className="mb-20 space-y-8" aria-label="Frequently Asked Questions">
                        ...
                        <div className="space-y-6">
                            <div className="border border-[#222] bg-[#101010] p-6 space-y-2">
                    ...
                    <section className="border border-[#222] bg-[#0d0d0d] p-10 md:p-16 text-center mb-20 relative overflow-hidden space-y-4">
                        <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight text-white">
                            Start Your Evolution
                        </h2>
                        <p className="text-sm font-mono text-[#D6A500] uppercase tracking-widest">
                        ...
                        <div className="text-xs font-mono text-[#888] uppercase space-y-1 py-2">
                    ...
                    <footer className="py-10 border-t border-[#222] text-center font-mono text-xs text-[#777] uppercase space-y-2 mb-10">
                        <p className="text-white font-bold tracking-wider">NOMADLIFEXP</p>
                        <p>Human Optimization System</p>
                        <p className="text-[#D6A500]">Evolve in Motion.</p>
                    </footer>
