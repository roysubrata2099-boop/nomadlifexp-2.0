            ...
            <div className="relative max-w-7xl mx-auto px-6 py-24">
                ...
                <header className="relative z-10 mb-24">
                    ...
                    <p className="mt-8 max-w-3xl text-neutral-400 font-mono leading-relaxed">
                        ...
                        It is an engineered execution architecture designed to construct long-term autonomy.
                    </p>
                </header>
                            ...
                            {disciplineArticles.map((post) => (
                                ...
                                >
                                    ...
                                    <Link
                                        ...
                                        className="inline-block mt-6 text-cyan-400 text-xs font-mono uppercase"
                                    >
                                        READ ARTICLE &rarr;
                                    </Link>
                                </article>
