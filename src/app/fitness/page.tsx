            ...
            <main className="relative z-10 max-w-7xl mx-auto px-6 py-32">
                ...
                <header className="mb-20 max-w-4xl">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black uppercase leading-none">
                        SOMATIC MECHANICS
                        <br />
                        <span className="text-cyan-400">&amp; KINETIC POWER</span>
                    </h1>
                    <p className="mt-8 text-neutral-400 font-mono leading-relaxed">
                ...
                <section>
                    <h2 className="mb-8 text-xs font-mono uppercase tracking-[0.4em] text-neutral-500">
                    ...
                    {fitnessArticles.length === 0 ? (
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {fitnessArticles.map((post) => (
                                <article
                                    key={post.slug}
                                    className="border border-neutral-800 bg-neutral-950 p-8 hover:border-cyan-500/50 transition"
                                >
                                    <h3 className="text-xl font-bold mb-4">{post.title}</h3>
                                    <p className="text-neutral-400 mb-6">{post.description}</p>
                                    <Link
                ...
                <footer className="mt-24 border-t border-neutral-900 pt-10 font-mono text-xs uppercase tracking-[0.3em]">
                    <h2 className="text-neutral-500 mb-6">// CROSS CONNECT NODES</h2>
                    <div className="flex gap-8">
                        <Link href="/discipline" className="hover:text-cyan-400 transition">
                            discipline &rarr;
                        </Link>
                        <Link href="/yoga" className="hover:text-cyan-400 transition">
                            yoga &rarr;
                        </Link>
                        <Link href="/mindset" className="hover:text-cyan-400 transition">
                            mindset &rarr;
                        </Link>
                    </div>
                </footer>
