...
export default function MindsetPage() {
    ...
    const mindsetPosts: SystemPost[] = allPosts
        .filter((post) => safeString(post.category).toLowerCase() === "mindset")
        .map((post) => ({
    ...
    const focusProtocols = [
        {
            title: "01 // Radical Information Elimination",
            text: "Protect attention by removing unnecessary inputs and controlling information exposure."
        },
        {
            title: "02 // Systematic Bias Disruption",
            text: "Audit mental frameworks and replace automatic reactions with intentional decision systems."
        },
        {
            title: "03 // Attention Chamber Integrity",
            text: "Create protected periods of deep focus where high-value execution can occur."
        }
    ];
        ...
        <div className="relative min-h-screen bg-black text-white overflow-hidden">
            ...
            <main className="relative z-10 max-w-7xl mx-auto px-6 py-32">
                <nav className="flex gap-5 border-b border-neutral-900 pb-6 mb-16 font-mono text-xs uppercase tracking-[0.3em]">
                    ...
                    <Link href="/blog" className="text-neutral-500 hover:text-cyan-400">
                        RETURN_TO_DIRECTORY
                    </Link>
                </nav>
                ...
                <header className="mb-20 max-w-5xl">
                    ...
                    <p className="mt-8 text-neutral-400 font-mono max-w-3xl leading-relaxed">
                        Perception is an adjustable framework. True psychological resilience is built through intentional identity architecture and cognitive optimization.
                    </p>
                </header>

                <section className="mb-20">
                    <h2 className="text-xs font-mono uppercase tracking-[0.4em] text-neutral-500 mb-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {focusProtocols.map((item) => (
                            <div key={item.title} className="border border-neutral-800 bg-neutral-950 p-8">
                                <h3 className="text-cyan-400 font-mono text-xs mb-4">
                                    {item.title}
                                </h3>
                ...
                <section>
                    ...
                    {mindsetPosts.length === 0 ? (
                        <div className="border border-neutral-800 p-8 text-neutral-500 font-mono">
                            ...
                            {mindsetPosts.map((post) => (
                                <article key={post.slug} className="border border-neutral-800 bg-neutral-950 p-8">
                                    ...
                                    <Link
                                        ...
                                        className="text-cyan-400 font-mono text-xs uppercase hover:text-cyan-300"
                                    >
                                        OPEN ARTICLE &rarr;
                                    </Link>
                                </article>
                ...
                <footer className="mt-24 border-t border-neutral-900 pt-10">
                    <h2 className="text-xs font-mono uppercase tracking-[0.4em] text-neutral-500 mb-6">
