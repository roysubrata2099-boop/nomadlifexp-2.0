...
const SYSTEMS_LIST: readonly SystemDetail[] = [
  {
    ...
    extraDesc: "Learn how to turn goals into repeatable actions, reduce your dependence on motivation, and build consistency that compounds over time.",
  ...
  },
  {
    ...
    extraDesc: "Fitness is not simply about appearance. It is about developing a body that can handle the demands of training, work, travel, everyday life, and the challenges you choose to pursue.",
  ...
  },
  {
    ...
    extraDesc: "Yoga complements physical training by helping you move with greater awareness while supporting recovery, flexibility, balance, and the connection between body and mind. The goal is not simply to perform poses. It is to become more aware of how you move, breathe, recover, and respond to your physical state.",
  ...
  },
  {
    ...
    extraDesc: "A resilient mindset is not about pretending everything is easy. It is about developing the perspective and confidence to respond to difficulty instead of being controlled by it.",
...
const PROCESS_STEPS: readonly ProcessStep[] = [
  {
    step: "01.",
    title: "AWARENESS",
    description: "Understand yourself, your habits, your environment, and your current physical and mental state. Awareness gives you an honest starting point. You cannot intentionally improve what you have not taken the time to understand.",
  },
  {
    step: "02.",
    title: "DISCIPLINE",
    description: "Turn intention into consistent action. Build routines, remove unnecessary friction, manage distractions, and develop the ability to follow through even when motivation disappears.",
  },
  {
    step: "03.",
    title: "STRENGTH",
    description: "Develop physical and mental capacity. Train your body, strengthen your resilience, and gradually increase your ability to handle challenge, discomfort, and responsibility.",
  },
  {
    step: "04.",
    title: "BALANCE",
    description: "Bring performance, recovery, movement, mindset, and lifestyle into a sustainable rhythm. Progress is not about pushing harder forever. It is about knowing when to train, when to recover, when to adapt, and when to continue.",
  },
  {
    step: "05.",
    title: "EVOLUTION",
    description: "Keep learning, adapting, and becoming more capable. Evolution is not a final destination. As you grow, your understanding changes, your challenges change, and the next level of development begins.",
  },
];

const OUTCOMES: readonly OutcomeItem[] = [
  { title: "STRONGER BODY", description: "Build physical strength, mobility, conditioning, and resilience." },
  { title: "SHARPER MIND", description: "Develop focus, awareness, confidence, and the ability to think and respond intentionally." },
  { title: "BETTER HABITS", description: "Create routines that make positive behavior easier to repeat." },
  { title: "GREATER DISCIPLINE", description: "Develop the ability to act consistently instead of relying entirely on motivation." },
  { title: "IMPROVED PERFORMANCE", description: "Increase your physical and mental capacity so you can perform better in training and everyday life." },
  { title: "SUSTAINABLE GROWTH", description: "Create progress that can continue over months and years instead of chasing short term extremes." },
];
    ...
    <div className="absolute inset-0 w-full h-full overflow-hidden bg-[#050816]">
      {!hasError ? (
        <>
          ...
          {/* Protection overlay shield to intercept context menu and saving */}
          <div
      ...
      <main className="pt-20 flex-grow">
        ...
        <section className="py-24 px-4 text-center border-b border-white/10">
          <div className="max-w-4xl mx-auto">
            <p className="text-xs font-mono uppercase tracking-[0.3em] text-cyan-400 mb-4">Human Optimization & Personal Growth</p>
            <h1 className="text-5xl md:text-8xl font-black uppercase tracking-tight mb-6">BUILD YOURSELF<br /><span className="text-cyan-400">LIKE A SYSTEM</span></h1>
            <p className="text-xs md:text-sm font-mono tracking-widest uppercase text-slate-400 mb-6">Discipline • Fitness • Yoga • Mindset</p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/start-here" className="w-full sm:w-auto px-8 py-4 bg-cyan-400 text-black font-bold uppercase text-xs tracking-wider hover:bg-cyan-300 transition-colors">
                Start Your Evolution &rarr;
              </Link>
              <Link href="/discipline-system" className="w-full sm:w-auto px-8 py-4 border border-white/20 text-white font-bold uppercase text-xs tracking-wider hover:bg-white/10 transition-colors">
        ...
        <section className="relative w-full py-24 px-4 overflow-hidden border-b border-white/10">
          <div className="max-w-5xl mx-auto relative z-20 text-center mb-12">
            <p className="text-xs font-mono uppercase tracking-[0.3em] text-cyan-400 mb-2">Movement • Breath • Control</p>
          ...
          <div className="max-w-3xl mx-auto text-slate-300 space-y-6 text-base md:text-lg leading-relaxed text-center">
            <p className="font-bold text-white uppercase tracking-wider text-sm">Movement is part of evolution.</p>
            <p>
              The way you move, breathe, recover, and experience your body influences how you perform and how you feel. Through yoga, mobility, breath, and mindful movement, NomadLifeXP explores the connection between physical awareness and personal growth.
            </p>
            ...
            <p className="font-mono text-cyan-400 uppercase tracking-widest text-xs pt-4">EVOLVE IN MOTION.</p>
          </div>
        </section>
        ...
        <section className="py-24 px-4 border-b border-white/10 bg-[#03050c]">
          <div className="max-w-4xl mx-auto">
            <p className="text-xs font-mono uppercase tracking-[0.3em] text-cyan-400 mb-2">Become more capable.</p>
            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight mb-8">What Is Human Optimization?</h2>
            ...
            <div className="space-y-6 text-slate-300 text-base md:text-lg leading-relaxed">
              ...
              <p>
                NomadLifeXP turns these principles into a practical framework for personal growth.
              </p>
              <p className="text-slate-300">
                The framework brings together four interconnected systems: Discipline, Fitness, Yoga, and Mindset. Each system develops a different aspect of human capability, while together they create a more complete approach to personal development.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4 text-sm font-mono text-cyan-300">
                <div className="p-4 bg-white/5 border border-white/10">Discipline creates consistency.</div>
                <div className="p-4 bg-white/5 border border-white/10">Fitness builds physical capacity.</div>
                <div className="p-4 bg-white/5 border border-white/10">Yoga develops movement, awareness, and recovery.</div>
                <div className="p-4 bg-white/5 border border-white/10">Mindset develops resilience, confidence, and adaptability.</div>
              </div>
              ...
              <div className="p-6 bg-cyan-950/20 border-l-4 border-cyan-400 my-6">
                <p className="font-bold text-white tracking-wider uppercase text-sm">Motivation fades. Systems endure.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-4 border-b border-white/10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <p className="text-xs font-mono uppercase tracking-[0.3em] text-cyan-400 mb-2">Four systems. One human.</p>
              <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight mb-6">The NomadLifeXP Framework</h2>
              <p className="text-slate-300 text-base md:text-lg leading-relaxed">
                Human development does not happen in isolation. Your physical condition can influence your confidence. Your habits influence your consistency. Your mobility affects how you move and recover. Your mindset influences how you respond when things become difficult. That is why NomadLifeXP connects these areas instead of treating them as separate goals.
              </p>
            </div>
            ...
            <div className="space-y-16">
              {SYSTEMS_LIST.map((sys) => (
                <div key={sys.number} className="p-8 md:p-12 bg-[#03050c] border border-white/10 rounded-2xl flex flex-col md:flex-row gap-8 items-start justify-between">
                  <div className="max-w-2xl space-y-4">
                    <div className="flex items-center gap-4">
                      <span className="text-3xl font-black text-cyan-400 font-mono">{sys.number}</span>
                      <h3 className="text-2xl md:text-3xl font-black uppercase">{sys.title}</h3>
                    </div>
                    <p className="text-xs font-mono uppercase tracking-widest text-cyan-300">{sys.coreFocus}</p>
                    <p className="text-slate-300 text-base leading-relaxed">{sys.description}</p>
                    {sys.extraDesc && <p className="text-slate-400 text-sm leading-relaxed">{sys.extraDesc}</p>}
                    <div className="pt-2">
                      <p className="text-xs font-mono uppercase tracking-wider text-slate-500 mb-1">Primary Outcome</p>
                      <p className="text-sm font-semibold text-white">{sys.primaryOutcome}</p>
                    </div>
                  </div>
                  <div className="w-full md:w-auto flex-shrink-0">
                    <Link href={sys.href} className="inline-block w-full md:w-auto px-6 py-3 bg-white/5 border border-white/20 text-white font-bold uppercase text-xs tracking-wider hover:bg-cyan-400 hover:text-black transition-colors text-center">
        ...
        <section className="py-24 px-4 border-b border-white/10 bg-[#03050c]">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <p className="text-xs font-mono uppercase tracking-[0.3em] text-cyan-400 mb-2">From chaos to clarity</p>
            ...
            <div className="space-y-12">
              {PROCESS_STEPS.map((p) => (
                <div key={p.step} className="flex flex-col md:flex-row gap-6 items-start border-l-2 border-cyan-400/40 pl-6">
                  <span className="text-xl font-mono font-black text-cyan-400">{p.step}</span>
                  <div className="space-y-2">
                    <h3 className="text-xl font-black uppercase text-white">{p.title}</h3>
                    <p className="text-slate-300 text-base leading-relaxed">{p.description}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="py-24 px-4 border-b border-white/10">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <p className="text-xs font-mono uppercase tracking-[0.3em] text-cyan-400 mb-2">Build the next version of yourself</p>
            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight mb-6">Why Human Optimization?</h2>
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            <div className="p-6 bg-white/5 border border-white/10 space-y-2">
              <p className="text-sm font-semibold text-white">It looks like keeping promises to yourself.</p>
            </div>
            <div className="p-6 bg-white/5 border border-white/10 space-y-2">
              <p className="text-sm font-semibold text-white">It looks like having the strength and mobility to move well.</p>
            </div>
            <div className="p-6 bg-white/5 border border-white/10 space-y-2">
              <p className="text-sm font-semibold text-white">It looks like building habits that continue working when motivation disappears.</p>
            </div>
            <div className="p-6 bg-white/5 border border-white/10 space-y-2">
              <p className="text-sm font-semibold text-white">It looks like responding to setbacks instead of being controlled by them.</p>
            </div>
            <div className="p-6 bg-white/5 border border-white/10 space-y-2">
              <p className="text-sm font-semibold text-white">It looks like recovering intelligently instead of constantly pushing yourself into exhaustion.</p>
            </div>
            <div className="p-6 bg-white/5 border border-white/10 space-y-2">
              <p className="text-sm font-semibold text-white">It looks like becoming more disciplined without becoming rigid.</p>
            </div>
          </div>

          <div className="max-w-xl mx-auto p-8 bg-cyan-950/30 border border-cyan-400/30 text-center space-y-3">
            <p className="text-xs font-mono uppercase tracking-widest text-cyan-400">The objective is simple:</p>
            <p className="text-sm font-mono uppercase tracking-wider text-slate-200">Become stronger. Become healthier. Become more disciplined. Become more resilient. Become more aware. Become more capable. One system at a time.</p>
          </div>
        </section>
        ...
        <section className="py-24 px-4 border-b border-white/10 bg-[#03050c]">
          <div className="max-w-6xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight">What Human Optimization Can Develop</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {OUTCOMES.map((item, idx) => (
                <div key={idx} className="p-8 bg-[#050816] border border-white/10 space-y-3">
                  <h3 className="text-lg font-black uppercase text-cyan-400">{item.title}</h3>
        ...
        <section className="py-24 px-4 border-b border-white/10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <p className="text-xs font-mono uppercase tracking-[0.3em] text-cyan-400 mb-2">Learn. Apply. Evolve.</p>
              <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight mb-4">Knowledge Library</h2>
              <p className="text-slate-300 text-base">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              {KNOWLEDGE_CATEGORIES.map((cat, idx) => (
                <div key={idx} className="p-8 bg-[#03050c] border border-white/10 flex flex-col justify-between space-y-4">
                  <div className="space-y-3">
                    <h3 className="text-2xl font-black uppercase">{cat.title}</h3>
                    <p className="text-xs font-mono uppercase tracking-widest text-cyan-400">{cat.focus}</p>
                    <p className="text-slate-300 text-sm leading-relaxed">{cat.description}</p>
                  </div>
                  <div>
                    <Link href={cat.href} className="inline-block text-xs font-mono uppercase tracking-wider text-cyan-300 hover:text-white transition-colors">
            ...
            <div className="text-center">
              <Link href="/blog" className="inline-block px-8 py-4 bg-white/5 border border-white/20 text-white font-bold uppercase text-xs tracking-wider hover:bg-cyan-400 hover:text-black transition-colors">
        ...
        <section className="py-24 px-4 border-b border-white/10 bg-[#03050c]">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <p className="text-xs font-mono uppercase tracking-[0.3em] text-cyan-400">We do not chase motivation. We build systems.</p>
            ...
            <div className="pt-6">
              <p className="font-mono text-sm uppercase tracking-widest text-cyan-400">THE GOAL IS NOT A TEMPORARY PEAK. IT IS A BETTER BASELINE.</p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              {FAQ_ITEMS.map((faq, idx) => (
                <div key={idx} className="p-8 bg-[#03050c] border border-white/10 space-y-3">
                  <h3 className="text-lg font-black uppercase text-cyan-300">{faq.question}</h3>
