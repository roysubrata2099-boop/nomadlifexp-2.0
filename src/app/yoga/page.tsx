...
export const metadata: Metadata = {
    ...
    title:
        "Yoga & Somatic Intelligence | NomadLifeXP",

    description:
        "Cultivate somatic intelligence, attention control protocols, and neurological stability.",

    alternates: {

        canonical:
            "https://nomadlifexp.com/yoga",
...
export default function YogaPage() {
    ...
    const alignmentMetrics = [

        {
            ...
            desc:
                "A body intelligence system designed to improve attention control through breathing mechanics, awareness, and nervous system regulation."
...

        {
            ...
            desc:
                "Somatic alignment strengthens the connection between intention, movement, and conscious execution."
